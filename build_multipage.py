...
# -*- coding: utf-8 -*-
"""
Multi-Page Portal Master Builder for Eng. Mostafa Abdelghany Portfolio (V3)
Generates all 9 interconnected, fully bilingual, high-performance HTML pages.
"""
...
# ==============================================================================
# 1. INDEX.HTML (Home Hub)
# ==============================================================================
index_html = get_head("Eng. Mostafa Abdelghany — MEP Procurement Section Head & Consultant") + get_navbar("index.html") + """
...
# ==============================================================================
# 3. SERVICES.HTML (Services & Freelance Consulting)
# ==============================================================================
services_html = get_head("Services & Freelance Consulting — Eng. Mostafa Abdelghany") + get_navbar("services.html") + """
...
# ==============================================================================
# 4. SOFTWARE.HTML (Software & Tools Stack)
# ==============================================================================
software_html = get_head("Software Stack & Engineering Tools — Eng. Mostafa Abdelghany") + get_navbar("software.html") + """
    <div style="padding-top: 130px; background: var(--bg-secondary); border-bottom: 1px solid rgba(196,163,90,0.15);">
...
# ==============================================================================
# 5. PROJECTS.HTML (All Projects Hub Directory)
# ==============================================================================
projects_html = get_head("Projects Directory — Eng. Mostafa Abdelghany") + get_navbar("projects.html") + """
    <div style="padding-top: 130px; background: var(--bg-secondary); border-bottom: 1px solid rgba(196,163,90,0.15);">
        <div class="container" style="padding-bottom: 50px;">
            <div class="section-title animate-on-scroll">
                <span class="title-number">01.</span>
            ...
            <div class="projects-grid" id="projects-grid-container">
                <!-- Dynamically rendered via scripts/projects.js -->
            </div>
        </div>
    </div>
""" + get_footer("<script src='scripts/projects.js'></script>")

# ==============================================================================
# 6. PROJECT-DETAIL.HTML (Dedicated Project Showcase with High-Res Gallery)
# ==============================================================================
project_detail_html = get_head("Project Showcase & Gallery — Eng. Mostafa Abdelghany") + get_navbar("project-detail.html") + """
...
""" + get_footer("<script src='scripts/project-detail.js'></script>")

# ==============================================================================
# 7. EXPERIENCE.HTML (Career Timeline & Companies)
# ==============================================================================
experience_html = get_head("Career Experience — Eng. Mostafa Abdelghany") + get_navbar("experience.html") + """
    <div style="padding-top: 130px; background: var(--bg-secondary); border-bottom: 1px solid rgba(196,163,90,0.15);">
        <div class="container" style="padding-bottom: 60px;">
            <div class="section-title animate-on-scroll">
                <span class="title-number">01.</span>
...
# ==============================================================================
# 8. CERTIFICATES.HTML (Certificates & Documents with 3D Flip)
# ==============================================================================
certificates_html = get_head("Certificates & SCE Membership — Eng. Mostafa Abdelghany") + get_navbar("certificates.html") + """
    <div style="padding-top: 130px; background: var(--bg-secondary); border-bottom: 1px solid rgba(196,163,90,0.15);">
        <div class="container" style="padding-bottom: 60px;">
            <div class="section-title animate-on-scroll">
                <span class="title-number">01.</span>
...
# ==============================================================================
# 9. CONTACT.HTML (Contact & Freelance Inquiry Form)
# ==============================================================================
contact_html = get_head("Contact & Hire Me — Eng. Mostafa Abdelghany") + get_navbar("contact.html") + """
    <div style="padding-top: 130px; background: var(--bg-secondary); border-bottom: 1px solid rgba(196,163,90,0.15);">
        <div class="container" style="padding-bottom: 60px;">
            <div class="section-title animate-on-scroll">
                <span class="title-number">01.</span>
...
# ==============================================================================
# Write all 9 HTML files
# ==============================================================================
pages = {
    'index.html': index_html,
    'about.html': about_html,
    'services.html': services_html,
    'software.html': software_html,
    'projects.html': projects_html,
    'project-detail.html': project_detail_html,
    'experience.html': experience_html,
    'certificates.html': certificates_html,
